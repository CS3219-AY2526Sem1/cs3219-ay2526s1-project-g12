...
export default function Verify() {
    ...
    useEffect(() => {
        if (!token) {
            ...
            setErrorDetails("Please check your verification email and use the correct link.");
            setStatus("error");
            return;
        }
                ...
                <div className="card-body items-center text-center">
                    ...
                    {status === "error" && (
                        <>
                            ...
                            <h2 className="card-title text-2xl mb-4">{message || "Verification Failed"}</h2>
                            ...
                            <div className="alert alert-error shadow-lg">
                                <div className="flex flex-col items-start w-full">
                                    ...
                                    <p className="text-sm text-left">{errorDetails || "An unknown error occurred."}</p>
                                </div>
                            </div>
